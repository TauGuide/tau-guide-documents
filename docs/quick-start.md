...
><br>
>
>   - **[DOWNLOAD](/)** : *Download the latest Tau Client to get started.* <br>
>   - **[IDNI Playground](https://idni.multilink.cloud/login)** : *Test the discussion platform using the IDNI Playground*

****

<br>

## Excellent Community Articles

### ▪ Tauchain 101 - Essential reading
By Rok Sivante <br>
...
### ▪ Tauchain - A self amending program
by Isar Flis <br>
...
### ▪ What is Tau and how does it compare to other Projects
by trafalgar (Miau Miau) <br>
https://steemit.com/cryptocurrency/@trafalgar/what-is-tau-my-only-other-crypto-investment

### ▪ Simplifying Tauchain
By Rok Sivante <br>
...
# Tauchain FAQs
Here is a collection of commonly asked questions. Gathered from [socials](http://tau.guide/social) and the team's [developmzzent video updates](/dev-video-updates) <br>
...
Pleas refer to our [How to Store Agoras](https://www.notion.so/How-to-Store-Agoras-66d92c0cc95e46d5896088808fc00615) tutorial.
...
[https://bitcointalk.org/index.php?topic=950309.msg20380555#msg20380555](https://bitcointalk.org/index.php?topic=950309.msg20380555#msg20380555)[https://bitcointalk.org/index.php?topic= 950309.msg17841993#msg17841993](https://bitcointalk.org/index.php?topic=%20950309.msg17841993#msg17841993)

---

### 8. What is the Roadmap for this project?

See Development progress on our Tauchain Project Roadmap 
...
We very much welcome technical questions. Please submit to either the [Monthy QA](http://bit.ly/TauchainQuestionForm) or in the [Tauchain IRC developer chat](https://t.me/joinchat/ElCYP1TPyRalxhCgi_5HxA) regarding any of these areas and more.

---

### 10. Where can I see the Tauchain code?

The Tauchain github repository is here [https://github.com/IDNI](https://github.com/IDNI)
...
*Ohad*: I don't anticipate the risk of this to be high as there's no notion of 'truth' in the network. If someone wants to believe 1+1=3, they can write so. No one can prevent them from doing so and very few will agree with them. It will not affect anyone else as it's only your own opinion. <br>
...
Read more about [The New Tau](http://www.idni.org/blog/the-new-tau).
...
Read more From Izar Flis's [Tau vs Tezos Article](https://steemit.com/tauchain/@flis/tau-is-a-discussion-about-tau)

---

### 21. Tau vs Wolfram

*Ohad*: There's a big difference: Wolfram is a tool to discover tools and to represent facts, mathematical and physical facts, while the concept of truth is an alien photo. <br>In Tau there is no truth, only opinions. It is first and foremost a social product, which enhances communication between people by allowing them to collaboratively reach decisions. <br><br>Wolfram has nothing to do with collaborative decision making.
...
You can follow [The Tau Devlopment Roadmap](https://tau.guide/#development-progress).

---

### 25. How can learn to code in TML?

You can read more about TML in the [TML Github Readme](https://github.com/IDNI/TML/blob/master/README.md) . There have been things changed and added contrary to the readme.

TML is pre-release and once it's released, proper documentation support will be provided.
